...
To update the database use this command from the Web project folder (replace `DDFinancePolicy` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../DDFinancePolicy.Infrastructure/DDFinancePolicy.Infrastructure.csproj -s DDFinancePolicy.Web.csproj
```
